...
class ProductController extends Controller
{
    ...
    public function store(ProductRequest $request)
    {
        try {
            ...
            return response()->json([
                'status' => 'Tạo mới nhà thành công',
                'product' => $product
            ], 201);
        } catch (\Exception $e) {
            return response()->json([
                'status' => 'Tạo mới nhà thất bại',
                'error' => $e->getMessage(),
            ], 500);
        }
    }
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            return response()->json(['status' => 'Cập nhật nhà thành công', 'product' => $product], 200);
        } catch (\Exception $e) {
            return response()->json(['status' => 'Cập nhật nhà thất bại', 'error' => $e->getMessage()], 500);
        }
    }

    public function delete($id)
    {
        return response()->json($this->productService->deleteProduct($id), 201);
    }
