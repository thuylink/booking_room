...
const LoginLinks = () => {
    ...
    const handleAddToCart = (productId) => {
        // Thực hiện các hành động liên quan đến thêm sản phẩm vào giỏ hàng
        ...
        <div className="al">
            <Navbar>
                ...
                <NavbarContent justify="end">
                    ...
                    <Link href="/register">
                        <Button style={{ margin: '1px 0' }}>Đăng ký với vai trò khách thuê</Button>
                    </Link>
                    <Link href="/login">
                        <Button style={{ margin: '1px 0' }}>Đăng nhập với vai trò khách thuê</Button>
                    </Link>
                    <Link href="/register-host">
                        <Button style={{ margin: '1px 0' }}>Đăng ký với vai trò chủ nhà</Button>
                    </Link>
                    <Link href="/login-host">
                        <Button style={{ margin: '1px 0' }}>Đăng nhập với vai trò chủ nhà</Button>
                    </Link>
                </div>
